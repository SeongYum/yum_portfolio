...
export const projects = [
  {
    ...
    learned: [
      '백엔드 개발자와 협업하는 과정과 git을 활용한 협업에 관해 많이 배울 수 있었습니다.',
      '협업 시 필요한 명세를 문서로 작성하여 소통했고, 매일 회의를 통해 일정을 조율하였습니다. 또한, 각 파트에 대한 부족한 정보나 지식을 서로 공유하며 프로젝트를 완성했습니다.',
